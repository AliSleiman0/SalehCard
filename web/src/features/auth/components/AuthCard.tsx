...
import { Logo, Segmented } from '@/components'
import { LoginCard } from './LoginCard'
import { SignupCard } from './SignupCard'

// AuthCard is the shared auth shell: logo, a Phone|Email tab, the form body
// (LoginCard/SignupCard), and the login↔register switch link.
